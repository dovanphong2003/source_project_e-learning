...
export const DetailCourse = () => {
    ...
    const getInfoCourseUseId = async () => {
        try {
            const response = await axios.get(
                `http://localhost:8081/course/getInfoCourseUseIdAPI?idCourse=${param.id}`
            );
    ...
    const fncgetInfoUserByAccessTokenAPI = async () => {
        try {
            const response = await axios.get(
                `http://localhost:8081/getInfoUserByAccessTokenAPI?accessToken=${AccessToken}`
            );
    ...
    const funcGetItemCartUser = async () => {
        try {
            const response = await axios.get(
                `http://localhost:8081/course/getCartItemsAPI?isIdUser=${dataUser.id}`
            );
    ...
    const handleAddCart = async (event) => {
        ...
        try {
            const response = await axios.post(
                `http://localhost:8081/course/addCourseToCartAPI?idCourse=${param.id}&id_user=${dataUser.id}`
            );
    ...
    const handleDeleteCart = async (event) => {
        ...
        try {
            const response = await axios.delete(
                `http://localhost:8081/course/deleteCourseCartAPI?idCourse=${param.id}&id_user=${dataUser.id}`
            );
    ...
    const checkCouseOfUser = async () => {
        try {
            const resposne = await axios.get(
                `http://localhost:8081/enrolment/getDataEnrolmentOfUserAPI?user_id=${dataUser.id}`
            );
